                ...
                if ',' in line:
                    ...
                    if len(parts) >= 2:
                        ...
                        try:
                            ...
                            print(f"  ⚠️  Invalid amount for tender '{tender_name}'")
                            continue
            
            # Report unrecognized tenders
            if unrecognized_tenders:
                print(f"  ⚠️  Unrecognized tenders: {', '.join(unrecognized_tenders)}")
            
            print(f"  ✓ Tenders: {recognized_count} types, ${total_tender:.2f} total")
            return True
